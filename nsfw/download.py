...
import nsfw.globals
from nsfw.filesystem import is_file
...
def conditional_download(download_directory_path: str, urls: List[str]) -> None:
	...
	for url in urls:
		...
		if initial_size < download_size:
			with tqdm(total=download_size, initial=initial_size, desc="Downloading", unit='B', unit_scale=True,
					  unit_divisor=1024, ascii=' =',
					  disable=nsfw.globals.log_level in ['warn', 'error']) as progress:
				subprocess.Popen(
