...
from nsfw.typings import ExecutionDevice, ValueAndUnit
...
def decode_execution_providers(execution_providers: List[str]) -> List[str]:
	logger.info(f'[ NSFW_CENSOR ] execution_providers: {execution_providers}', __name__.upper())
	...
	logger.info(f'[ NSFW_CENSOR ] encoded_execution_providers: {encoded_execution_providers}', __name__.upper())
